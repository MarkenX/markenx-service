...
import com.udla.markenx.application.dtos.mappers.CourseDtoMapper;
import com.udla.markenx.application.dtos.mappers.StudentMapper;
import com.udla.markenx.application.dtos.requests.CreateCourseRequestDTO;
import com.udla.markenx.application.dtos.requests.UpdateCourseRequestDTO;
...
public class CourseController implements CourseControllerPort {
  ...
  public ResponseEntity<Page<CourseResponseDTO>> getAllCourses(
    ...
    Page<com.udla.markenx.core.models.Course> courses = courseService.getAllCourseIds(page, size);
  ...
  public ResponseEntity<CourseResponseDTO> getCourseById(
    ...
    com.udla.markenx.core.models.Course course = courseService.getCourseById(id);
