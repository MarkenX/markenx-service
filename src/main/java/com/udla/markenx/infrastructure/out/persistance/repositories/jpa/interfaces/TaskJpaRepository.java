...
public interface TaskJpaRepository extends JpaRepository<TaskJpaEntity, Long> {
	...
	// Page<TaskJpaEntity> findByStudentIdAndCurrentStatus(Long studentId,
	// AssignmentStatus currentStatus,
	// Pageable pageable);

	// Page<TaskJpaEntity> findByStudentIdAndDueDateBetween(Long studentId,
	// LocalDate startDate, LocalDate endDate,
	// Pageable pageable);

	// Page<TaskJpaEntity> findByStudentIdAndDueDateBetweenAndCurrentStatus(Long
	// studentId, LocalDate startDate,
