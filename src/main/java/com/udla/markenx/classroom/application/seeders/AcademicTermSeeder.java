...
public class AcademicTermSeeder implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    try {
      ...
      if (repository.findAll(org.springframework.data.domain.Pageable.unpaged()).getTotalElements() > 0) {
      ...
      System.out.println("  ✓ Created: " + term2025_1.getCode() + " (" + term2025_1.getLabel() + ") [HISTORICAL]");
      ...
      System.out.println("  ✓ Created: " + term2025_2.getCode() + " (" + term2025_2.getLabel() + ") [ACTIVE]");

      System.out.println("[1/4] ✓ Academic Terms seeded successfully!\n");
    } catch (Exception e) {
      System.err.println("[1/4] ✗ ERROR seeding Academic Terms: " + e.getMessage());
      e.printStackTrace();
      throw e;
    }
  }
